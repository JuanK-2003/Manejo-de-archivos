 ...
 * @author Juan_K
 */
public class add_pr extends javax.swing.JInternalFrame {
    public static ArrayList<String> text = new ArrayList();
    String products = System.getProperty("user.home");
    String nombreArchivo = "Products.txt";
    String ruta = products + File.separator + nombreArchivo; 
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            text.add(new String(jTextField1.getText()));
            f.write("\n\r" + text);
            f.close();
